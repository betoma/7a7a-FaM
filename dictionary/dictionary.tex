...
\begin{dictroot}{\bigglot}{rk}
    \begin{dictentry}{{\bigglot}uRKu}{n.}
        \dictdef*{
            bear, animal in the family Ursidae
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{bl}{n}\label{root:BL_N}
    % city, village, town
    \begin{dictentry}{iBLuNa}{n.}\label{word:iBLuNa}
        \dictdef*{
...
\begin{dictroot}{br}{t}\label{root:BR_T}
    ...
    \begin{dictentry}{BRaTa}{adj.}\label{word:BRaTa}
        \dictdef*{
            Welsh, of or relating to Wales
        }
    \end{dictentry}
    \begin{dictentry}{BRuuT}{n.}\label{word:BRuuT}
        ...
        \dictdef{
            the Britons, the non-Germanic peoples inhabiting the island of Great Britain
        }
    \end{dictentry}
    \begin{dictentry}{BRaTia}{n.}\label{word:BRaTia}
        \dictdef*{
            \emph{(political)} Wales as a geopolitical entity, the nation of Wales
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{c}{mp}\label{root:C_MP}
    ...
    \end{dictentry}
    \dictsubtitle{Idiomatic Expressions}
    \begin{dictentry}{CuMPu CuMPuuru}{}
        \dictdef*{
...
\begin{dictroot}{d}{m}\label{root:D_M}
    ...
    \end{dictentry}
    \begin{dictentry}{DasiM}{n.}\label{word:DasiM}
        \dictdef{
            bridge, usually across a stream
        }
        \dictdef{
            walkway
        }
...
\begin{dictroot}{f}{hj}
    \begin{dictentry}{FaHJa}{adj.}
        \dictdef*{spread out}
        \dictdef*{popular, well-known}
        \dictdef{(of a disease) infectious, communicable}
        \dictdef{(internet) viral, popular}
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{h}{h}\label{root:H_H}
    ...
    \begin{dictentry}{HiiH}{v.tr.}\label{word:HiiH}
        ...
        \dictdef{
            \textit{fig.} to confuse \textit{sme.}
        }
    \end{dictentry}
...
\begin{dictroot}{h}{j}\label{root:H_J}
    ...
    \end{dictentry}
\dictsubtitle{Compounds \& Secondary Derivations}
    \begin{dictentry}{BaJa-HaJ}{n.}\label{word:BaJa-HaJ}
        \dictdef*{
            Wednesday, the third day of the seven-day week
        }
    \end{dictentry}
    ...
    \end{dictentry}
    \begin{dictentry}{FanaS-HaJ}{n.}\label{word:FanaS-HaJ}
        \dictdef*{
            Monday, the first day of the seven-day week
        }
    \end{dictentry}
    \begin{dictentry}{JaN-HaJ}{n.}\label{word:JaN-HaJ}
        \dictdef*{
            Friday, the fifth day of the seven-day week
        }
    \end{dictentry}
    \begin{dictentry}{ler-HaJ}{n.}\label{word:ler-HaJ}
        \dictdef*{
            Saturday, the sixth day of the seven-day week
        }
    \end{dictentry}
    \begin{dictentry}{ManaM-HaJ}{n.}\label{word:ManaM-HaJ}
        \dictdef*{
            Sunday, the seventh day of the seven-day week
        }
    \end{dictentry}
    \begin{dictentry}{tir-HaJ}{n.}\label{word:tir-HaJ}
        \dictdef*{
            Tuesday, the second day of the seven-day week
        }
    \end{dictentry}
    \begin{dictentry}{tur-HaJ}{n.}\label{word:tur-HaJ}
        \dictdef*{
            Thursday, the fourth day of the seven-day week
        }
    \end{dictentry}
...
\begin{dictroot}{h}{lh}\label{root:H_LH}
    \begin{dictentry}{HaLH}{n.}\label{word:HaLH}
        \dictdef*{
            inside, interior, internals
        }
    \end{dictentry}
\end{dictroot}

\begin{dictroot}{h}{n}\label{root:H_N}
    \begin{dictentry}{HaN}{n.}\label{word:HaN}
        \dictdef*{
            story, tale, legend, poem, fable
        }
    \end{dictentry}
    \begin{dictentry}{HiiN}{v.tr.}\label{word:HiiN}
        \dictdef*{
            (of a story) to tell, to recite, to describe in a story or verse, to tell a story about
        }
    \end{dictentry}
    \begin{dictentry}{HiyaN}{v.intr.}\label{word:HiyaN}
        \dictdef*{
            to be fabled, to be rumored, to be said (in stories or legends)
        }
    \end{dictentry}
    \begin{dictentry}{iHaaN}{v.intr.}\label{word:iHaaN}
        \dictdef*{
            to tell a story, to recite a poem
        }
    \end{dictentry}
    \begin{dictentry}{HaNa}{adj.}\label{word:HaNa}
        \dictdef*{
            legendary, fantastic, fabled, poetic, like something from a storybook
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{h}{r}\label{root:H_R}
    \begin{dictentry}{HiyaR}{v.intr.}\label{word:HiyaR}
        \dictdef{
            to burn, be burning
        }
    \end{dictentry}
...
\begin{dictroot}{j}{jn}{\label{root:J_JN}}
    \begin{dictentry}{YiiYN}{v.tr.}\label{wor:YiiYN}
        \dictdef*{
            to take \textit{smth.}, appropriate \textit{smth.} for oneself
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{j}{n}\label{root:J_N}
    \begin{dictentry}{JaN}{n.}\label{word:JaN}
        \dictdef{
            nap
        }
        \dictdef{
...
\begin{dictroot}{jp}{n}\label{root:JP_N}
    \begin{dictentry}{JPaNa}{adj.}\label{word:JPaNa}
        \dictdef*{
            Japanese, of/about/from Japan
        }
    \end{dictentry}
    \begin{dictentry}{iJuPa}{n.}\label{word:iJuPa}
        \dictdef*{
            the Japanese archipelago, the islands constituting Japan
        }
    \end{dictentry}
...
\begin{dictroot}{k}{l}\label{root:K_L}
    ...
    \end{dictentry}
    \begin{dictentry}{iKuLa}{n}\label{word:iKuLa}
        \dictdef{
            sea, ocean, large body of water
        }
        \dictdef{
            seaside, near the ocean, the beach
        }
    \end{dictentry}
...
\begin{dictroot}{k}{n}\label{root:K_N}
    ...
    \begin{dictentry}{aaKiN}{v.tr.}\label{word:aaKiN}
        \dictdef*{
            to promote \textit{sme. or smth.}, to advertise \textit{sme.}
        }
    \end{dictentry}
    \begin{dictentry}{KaNa}{adj.}\label{word:KaNa}
        \dictdef*{
            familiar, recognizable
        }
    \end{dictentry}
    \begin{dictentry}{uKiNi}{adj.}\label{word:uKiNi}
        \dictdef*{
            feeling deja vu, feeling like things are familiar
        }
    \end{dictentry}
    \begin{dictentry}{KanaN}{n.}\label{word:KanaN}
        \dictdef*{
            neighbor, familiar figure
        }
    \end{dictentry}
...
\begin{dictroot}{k}{p}\label{root:K_P}
    % marriage, spouse
    \begin{dictentry}{KaP}{n.}\label{word:KaP}
        \dictdef*{
            marriage, weddedness
        }
    \end{dictentry}
    ...
    \end{dictentry}
    \begin{dictentry}{KaPa}{adj.}\label{word:KaPa}
        \dictdef*{
            married, wed
        }
    \end{dictentry}
...
\begin{dictroot}{k}{pk}\label{root:K_PK}
    % fiancé(e), engagement
    \begin{dictentry}{KaPK}{n.}\label{word:KaPK}
        \dictdef*{
    ...
    \end{dictentry}
    \begin{dictentry}{KaPKa}{adj.}\label{word:KaPKa}
        \dictdef*{
            engaged, betrothed
        }
    \end{dictentry}
...
\begin{dictroot}{k}{rs}\label{root:K_RS}
    \begin{dictentry}{KaRS}{n.}\label{word:KaRS}
        \dictdef*{
            deterrent
        }
    \end{dictentry}
    \begin{dictentry}{KiiRS}{v.}\label{word:KiiRS}
        \dictdef*{
            to withdraw from and avoid \textit{smth. or sme.} following a related negative experience
        }
    \end{dictentry}
    \begin{dictentry}{KiyaRS}{v.}\label{word:KiyaRS}
        \dictdef*{
            to be avoided after negatively impacting \textit{sme.}    
        }
    \end{dictentry}
    \begin{dictentry}{iKaaRS}{v.}\label{word:iKaaRS}
        \dictdef*{
            to withdraw oneself in fear of creating or exacerbating a negative experience
            \begin{quote}
                \famword{ha MIKAEl bus BaJairi\lilglot iMaaMuc udan iKaaRS.}\\
                \textit{`Mikael left out of embarrassment after making a bad joke.'}
            \end{quote}
        }
    \end{dictentry}
    \begin{dictentry}{KiKiyaRS}{v.}\label{word:KiKiyars}
        \dictdef*{
            to prevent or deter a person's interaction with \textit{smth. or sme.} by providing negative reinforcement
            \begin{quote}
                \famword{WaLa TRanaL DasiM KiKiyaRSe\lilglot hak.}\\
                \textit{`The old troll is still stopping people from using the bridge.'}
            \end{quote}
        }
    \end{dictentry}
    \begin{dictentry}{aaKiRS}{v.}\label{word:aaKiRS}
        \dictdef*{
            to inhibit or discourage the behavior of \textit{smth. or sme.} by providing negative reinforcement
        }
    \end{dictentry}
    \begin{dictentry}{KaRSa}{adj.}\label{word:KaRSa}
        \dictdef*{
            \textit{(of an activity)} discouraged, not recommended
        }
    \end{dictentry}
    \begin{dictentry}{uKiRSi}{adj.}\label{word:uKiRSi}
        \dictdef*{
            \textit{(of a person or animal)} withdrawn, disheartened
        }
        % this could also mean embarrassed, but idk about that. 
    \end{dictentry}
    \begin{dictentry}{KanaRS}{n.}\label{word:KanaRS}
        \dictdef*{
            person who is overly intimidated by new experiences
        }
    \end{dictentry}
    \begin{dictentry}{KuRSu}{n.}\label{word:KuRSu}
        \dictdef*{
            animal, usually a pet, who is overly intimidated by new experiences
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{k}{t}\label{root:K_T}
    ...
    \begin{dictentry}{KaTa}{adj.}\label{word:KaTa}
        \dictdef*{
            Scottish, Scotch, from/of/about Scotland
        }
    \end{dictentry}
    ...
    \end{dictentry}
    \begin{dictentry}{KaTia}{n.}\label{word:KaTia}
        \dictdef*{
            \emph{(politics)} Scotland as a geopolitical entity, the nation of Scotland
        }
    \end{dictentry}
\end{dictroot}
...
\dictsubtitle{Compounds \& Secondary Derivations}
    ...
    \end{dictentry}
    \begin{dictentry}{TOBA-KajuWa}{n.}\label{word:TOBA-KajuWa}
        \dictdef*{
            tobacco, tobacco leaves\\
            \textit{(often shortened to \famword{TOBKWa})}
        }
    \end{dictentry}
...
\begin{dictroot}{kr}{d}\label{root:KR_D}
    ...
    \begin{dictentry}{KRanaD}{n.}\label{word:KRanaD}
        \dictdef{
            ...
            grandmother, grandfather, great aunt, great uncle, etc.
        }
        \dictdef{
            grandchild considered less close due to not being related by blood or otherwise, %
            granddaughter, grandson, great niece, great nephew, etc.
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{l}{f}\label{root:L_F}
    % to love (romantically)
    \begin{dictentry}{LaF}{n.}\label{word:LaF}
        \dictdef*{
            love, romantic love, affection
        }
    \end{dictentry}
    \begin{dictentry}{LiiF}{v.tr.}\label{word:LiiF}
        \dictdef*{
            to love \textit{sme.} romantically
        }
    \end{dictentry}
    \begin{dictentry}{LiyaF}{v.intr.}\label{word:LiyaF}
        \dictdef*{
            to be in love, to feel romantic love
        }
    \end{dictentry}
    \begin{dictentry}{iLaaF}{v.intr.}\label{word:iLaaF}
        \dictdef*{
            to be dating, to date, to be in a romantic relationship
        }
    \end{dictentry}
    \begin{dictentry}{LiLiyaF}{v.tr.}\label{word:LiLiyaF}
        \dictdef*{
            to attract \textit{sme.}, to have features and traits which cause \textit{sme.} to experience romantic affection for or desire to be in a romantic relationship with you
        }
    \end{dictentry}
    \begin{dictentry}{aaLiF}{v.tr.}\label{word:aaLiF}
        \dictdef*{
            to ask \textit{sme.} out, to ask \textit{sme.} to go steady with you, to ask \textit{sme.} to be in a romantic relationship
        }
    \end{dictentry}
    \begin{dictentry}{LaFa}{adj.}\label{word:LaFa}
        \dictdef*{
            romantic
        }
    \end{dictentry}
    \begin{dictentry}{uLiFi}{adj.}\label{word:uLiFi}
        \dictdef*{
            in love, infatuated, warm and fuzzy, butterflies in the stomach
        }
    \end{dictentry}
    \begin{dictentry}{LanaF}{n.}\label{word:LanaF}
        \dictdef*{
            significant other, boyfriend, girlfriend, datemate, romantic partner
        }
    \end{dictentry}
    \begin{dictentry}{inLiF}{n.}\label{word:inLiF}
        \dictdef*{
            crush, puppy love, infatuation
        }
    \end{dictentry}
\end{dictroot}

\begin{dictroot}{l}{ks}\label{root:L_KS}
    %salmon
    \begin{dictentry}{LuKSu}{n.}\label{word:LuKSu}
        \dictdef*{
            salmon
        }
    \end{dictentry}
...
\begin{dictroot}{l}{s}\label{root:L_S}
    %to walk
    \begin{dictentry}{LaS}{n.}\label{word:LaS}
        \dictdef*{
            walk, movement, trek, journey
        }
    \end{dictentry}
    \begin{dictentry}{LiiS}{v.tr.}\label{word:LiiS}
        \dictdef*{
            to walk \textit{smwh.}
        }
    \end{dictentry}
    \begin{dictentry}{LiyaS}{v.intr.}\label{word:LiyaS}
        \dictdef{
            \textit{(of a road or path)} to be well-trodden, to be frequently used
        }
        \dictdef{
            \textit{(fig.)} to be well-known and understood
        }
    \end{dictentry}
    \begin{dictentry}{iLaaS}{v.intr.}\label{word:iLaaS}
        \dictdef*{
            to go walking, to take a walk
        }
    \end{dictentry}
    \begin{dictentry}{LiLiyaS}{v.tr.}\label{word:LiLiyaS}
        \dictdef*{
            \textit{(of an area)} to clear a path through, to tame, to build a road through, to blaze a trail in
        }
    \end{dictentry}
    \begin{dictentry}{aaLiS}{v.tr.}\label{word:aaLiS}
        \dictdef{
            \textit{(of a person or animal)} to lead \textit{sme. or smth.}, to drive \textit{sme. or smth.} ahead of/along with you
        }
        \dictdef{
            \textit{(of a higher power)}to believe in \textit{sme. or smth.}
            }        
        \dictdef{
            \textit{(inverse)} to follow the practices of \textit{smth.}
            }
        \dictdef{
            \textit{(inverse)} to consent to \textit{smth.}, to agree to go along with \textit{smth.}
            }
        \dictdef{
            \textit{(inverse)} to recognize \textit{country} as an independent sovereign state
            }
    \end{dictentry}
    \begin{dictentry}{mLiS}{n.}\label{word:mLiS}
        \dictdef*{
            shoe, shoes
        }
    \end{dictentry}
    \begin{dictentry}{LasiS}{n.}\label{word:LasiS}
        \dictdef*{
            road, path, way
        }
    \end{dictentry}
...
\begin{dictroot}{l}{t}\label{root:L_T}
    \begin{dictentry}{LaT}{n.}\label{word:LaT}
        \dictdef*{
            trash, refuse, waste
        }
    \end{dictentry}
    \begin{dictentry}{LiiT}{v.tr.}\label{word:LiiT}
        \dictdef*{
            to excrete \textit{smth.}, to shit \textit{smth.} out
        }
    \end{dictentry}
    \begin{dictentry}{iLaaT}{v.intr.}\label{word:iLaaT}
        \dictdef*{
            to poop, to shit, to excrete waste
        }
    \end{dictentry}
    \begin{dictentry}{aaLit}{v.tr.}\label{word:aaLit}
        \dictdef*{
            to give \textit{sme.} the shits, cause stomach upset
        }
    \end{dictentry}
    \begin{dictentry}{LaTa}{adj.}\label{word:LaTa}
        \dictdef*{
            shitty, trashy, garbage
        }
    \end{dictentry}
    \begin{dictentry}{uLiTi}{adj.}\label{word:uLiTi}
        \dictdef{
            constipated
        }
        \dictdef{
            \textit{(fig.)} irritable, easily annoyed
        }
    \end{dictentry}
    \begin{dictentry}{LurTi}{n.}\label{word:LurTi}
        \dictdef*{
            feces, poo, a piece of poop
        }
    \end{dictentry}
    \begin{dictentry}{LarTi}{n.}\label{word:LarTi}
        \dictdef*{
            diarrhea, liquid poo, runny shit
        }
    \end{dictentry}
    \begin{dictentry}{iLuTa}{n.}\label{word:iLuTa}
        \dictdef{
            bathroom, outhouse
        }
        \dictdef{
            midden (an old dump for domestic waste)
        }
    \end{dictentry}
    \begin{dictentry}{LuliT}{n.}\label{word:LuliT}
        \dictdef*{
            colon, lower intestines
        }
    \end{dictentry}
    \begin{dictentry}{LasiT}{n.}\label{word:LasiT}
        \dictdef*{
            a long, skinny turd
        }
    \end{dictentry}
    \begin{dictentry}{aLiTu}{n.}\label{word:aLiTu}
        \dictdef{
            diaper
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{LimiTu}{n.}\label{word:LimiTu}
        \dictdef*{
            toilet, toilet bowl
        }
    \end{dictentry}
...
\begin{dictroot}{l}{w}\label{root:L_W}
    % high, top, above, rise/raise
    \begin{dictentry}{LaW}{n.}\label{word:LaW}
        \dictdef*{
            up, the top, topside
        }
    \end{dictentry}
    \begin{dictentry}{LaWa}{adj.}\label{word:LaWa}
        \dictdef*{
            upper, top
        }
    \end{dictentry}
    \begin{dictentry}{LaWjalaW}{n.}\label{word:LaWjalaW}
        \dictdef*{
...
\begin{dictroot}{lb}{n}\label{root:LB_N}
    %etymology: from Celtic "Albion"
    \begin{dictentry}{LBaNa}{adj.}\label{word:LBaNa}
        \dictdef*{
            British, associated with the population of Great Britain as a whole rather than one nation in particular
        }
    \end{dictentry}
    \begin{dictentry}{iLBuNa}{n.}\label{word:iLBuNa}
        \dictdef*{
            Great Britain, the island to the northwest of continental Europe on which the modern countries of England, Scotland, and Wales are located
        }
    \end{dictentry}
    \begin{dictentry}{LBaNia}{n.}\label{word:LBaNia}
        \dictdef*{
            the United Kingdom, Great Britain as a geopolitical polity
        }
    \end{dictentry}
    \begin{dictentry}{LBuNaw}{n., adv.}\label{word: LBuNaw}
        \dictdef{
            south
        }
        \dictdef{
...
\begin{dictroot}{lh}{m}\label{root:LH_M}
    \begin{dictentry}{LeHaM}{n.}\label{word:LHaM}
        \dictdef*{
            doubt, question, suspicion
        }
    \end{dictentry}
    \begin{dictentry}{LeHiiM}{v.tr}\label{word:LHiiM}
        \dictdef*{
            to doubt \textit{smth.}, to question \textit{smth.}
        }
    \end{dictentry}
    \begin{dictentry}{LeHiyaM}{v.intr.}\label{word:LHiyaM}
        \dictdef*{
            to be questioned, to be doubted, to be scrutinized
        }
    \end{dictentry}
    \begin{dictentry}{iLHaaM}{v.intr.}\label{word:iLHaaM}
        \dictdef*{
            to be suspicious, to feel suspicion about things, to be full of doubt
        }
    \end{dictentry}
    \begin{dictentry}{LeHiLHiyaM}{v.tr.}\label{word:LHiLHiyaM}
        \dictdef*{
            to question \textit{sme.}, to interrogate \textit{sme.}
        }
    \end{dictentry}
    \begin{dictentry}{aaLHiM}{v.tr.}\label{word:aaLHiM}
        \dictdef*{
...
\begin{dictroot}{lj}{d}\label{root:LJ_D}
    % listen, sound, loud, ear
    \begin{dictentry}{LJaD}{n.}\label{word:LJaD}
        \dictdef{
            sound
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{LYiiD}{v.tr.}\label{word:LYiiD}
        \dictdef*{
            to listen to a sound
        }
    \end{dictentry}
    \begin{dictentry}{LYiyaD}{v.intr.}\label{word:LYiyaD}
        \dictdef*{
            to be heard, to be listened to
        }
    \end{dictentry}
    \begin{dictentry}{iLJaaD}{v.intr.}\label{word:iLJaaD}
        \dictdef*{
            to make sound, to cry out
        }
    \end{dictentry}
    \begin{dictentry}{aaLYiD}{v.intr.}\label{word:aaLYiD}
        \dictdef*{
            to sound, to cause to make sound
        }
    \end{dictentry}
    \begin{dictentry}{LJaDa}{adj.}\label{word:LJaDa}
        \dictdef*{
            loud
        }
    \end{dictentry}
    \begin{dictentry}{LJuliD}{n.}\label{word:LJuliD}
        \dictdef*{
            ear, ears (body part)
        }
    \end{dictentry}
\dictsubtitle{Compounds \& Secondary Derivations}
    \begin{dictentry}{BuliT-mLYiD}{n.}\label{word:BuliT-mLYiD}
        \dictdef*{
            headphones, earbuds
        }
    \end{dictentry}
    \begin{dictentry}{JaBa-mLYiD}{n.}\label{word:JaBa-mLYiD}
        \dictdef*{
            musical instrument
        }
    \end{dictentry}
    \begin{dictentry}{NaSa-mLYiD}{n.}\label{word:NaSa-mLYiD}
        \dictdef*{
            speaker, speakers, boombox, megaphone, microphone
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{m}{b}\label{root:M_B}
    % slow
    \begin{dictentry}{MiyaB}{v.intr.}\label{word:MiyaB}
        \dictdef*{
            to take a long time, to be a slow, drawn-out process
        }
    \end{dictentry}
    \begin{dictentry}{iMaaB}{v.intr.}\label{word:iMaaB}
        \dictdef{
            to move slowly, to move hesitantly, to hesitate
        }
    \end{dictentry}
    \begin{dictentry}{MiMiyaB}{v.tr.}\label{word:MiMiyaB}
        \dictdef*{
            to delay, to hinder, to draw \textit{smth.} out
        }
    \end{dictentry}
    \begin{dictentry}{aaMiB}{v.tr.}\label{word:aaMiB}
        \dictdef*{
            to deter \textit{sme.}, to discourage \textit{sme.} (from \textit{smth.})
        }
    \end{dictentry}
    \begin{dictentry}{MaBa}{adj.}\label{word:MaBa}
        \dictdef*{
            slow, gradual
        }
    \end{dictentry}
    \begin{dictentry}{MuBu}{n.}\label{word:MuBu}
        \dictdef*{
            turtle
        }
    \end{dictentry}
\dictsubtitle{Compounds \& Secondary Derivations}
    \begin{dictentry}{LaSa-MuBu}{n.}\label{word:LaSa-MuBu}
        \dictdef*{
            tortoise, land turtle
        }
    \end{dictentry}
    \begin{dictentry}{PLaDa-MuBu}{n.}\label{word:PLaDa-MuBu}
        \dictdef*{
            sea turtle
        }
    \end{dictentry}
...
\begin{dictroot}{m}{c}\label{root:M_C}
    %monkey -- something else as well maybe?
    \begin{dictentry}{MuCu}{n.}\label{word:MuCu}
        \dictdef*{
            monkey
        }
    \end{dictentry}
...
\begin{dictroot}{m}{h}\label{root:M_H}
    \begin{dictentry}{MaH}{n.}\label{word:MaH}
        \dictdef{
            name, moniker, title
            \begin{quote}
        ...
        \dictdef{
            ...
            \begin{quote}
                \famword{nike MaH wan mLiS nas kaj.}\\
                I want Nike-brand shoes.
            \end{quote}
        }
    \end{dictentry}
    \begin{dictentry}{MiiH}{v.tr.}\label{word:MiiH}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{MiyaH}{v.intr.}\label{word:MiyaH}
        \dictdef*{
            to lactate, to produce milk
        }
    \end{dictentry}
    \begin{dictentry}{iMaaH}{v.intr.}\label{word:iMaaH}
        \dictdef*{
            to call out one's name, to sound off
        }
    \end{dictentry}
    \begin{dictentry}{MiMiyaH}{v.tr}\label{word:MiMiyaH}
        \dictdef*{
            to milk \textit{smth.}, to extract milk from \textit{smth.}
        }
    \end{dictentry}
    \begin{dictentry}{aaMiH}{v.tr.}\label{word:aaMiH}
        \dictdef*{
    ...
    \end{dictentry}
    \begin{dictentry}{MaHa}{adj.}\label{word:MaHa}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{uMiHi}{adj.}\label{word:uMiHi}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{ManaH}{n.}\label{word:ManaH}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{MurHi}{n.}\label{word:MurHi}
        \dictdef*{
            butter
        }
    \end{dictentry}
    \begin{dictentry}{MarHi}{n.}\label{word:MarHi}
        \dictdef{
            cow's milk
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{iMuHa}{n.}\label{word:iMuHa}
        \dictdef{
            dairy farm
        }
        \dictdef{
    ...
    %    \dictdef*{}
    %\end{dictentry}
    \begin{dictentry}{inMiH}{n.}\label{word:inMiH}
        \dictdef{
            calf, baby cow
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{MuliH}{n.}\label{word:MuliH}
        \dictdef*{
            breast, tit, udder, teat
        }
    \end{dictentry}
    \begin{dictentry}{MuHu}{n.}\label{word:MuHu}
        \dictdef{
            cow, head of cattle
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{MasiH}{n.}\label{word:MasiH}
        \dictdef*{
            stick of ice cream, ice pop
        }
    \end{dictentry}
    \begin{dictentry}{MajuHa}{n.}\label{word:MajuHa}
        \dictdef*{
            sign, nameplate
        }
    \end{dictentry}
    \begin{dictentry}{MidiH}{n.}\label{word:MidiH}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{MuHi}{adj., n.}\label{word:MuHi}
        \dictdef*{
            cream-colored, the color cream, off-white
        }
    \end{dictentry}
    \begin{dictentry}{aMiHu}{n.}\label{word:aMiHu}
        \dictdef*{
            milk carton
        }
    \end{dictentry}
    \begin{dictentry}{MimiHu}{n.}\label{word:MimiHu}
        \dictdef*{
            baby bottle
        }
    \end{dictentry}
\dictsubtitle{Compounds \& Secondary Derivations}
    \begin{dictentry}{MarHibin}{n}\label{word:MarHibin}
        \dictdef*{
            cream, milk fat
        }
    \end{dictentry}
...
\begin{dictroot}{m}{nt}
    ...
    \end{dictentry}
    \begin{dictentry}{ManaNT}{n.}
        \dictdef{
            giant, troll
        }
        \dictdef{
            mogul, VIP, important/significant person
        }
    \end{dictentry}
...
\begin{dictroot}{n}{ks}
    \begin{dictentry}{NaKS}{n.}
        \dictdef{politics}
        \dictdef{decision}
        \dictdef{debate, argument}
    \end{dictentry}
    \begin{dictentry}{NiiKS}{v.}
        \dictdef*{to discuss, argue about \textit{smth.}}
    \end{dictentry}
    \begin{dictentry}{NiyaKS}{v.}
        \dictdef*{\textit{of a topic} to spark debate}
    \end{dictentry}
    \begin{dictentry}{iNaaKS}{v.}
        \dictdef*{to debate, argue}
    \end{dictentry}
    \begin{dictentry}{NiNiyaKS}{v.}
        \dictdef*{(to suggest? bring up for debate?)}
    \end{dictentry}
    \begin{dictentry}{aaNiKS}{v.}
        \dictdef*{(to )}
    \end{dictentry}
    \begin{dictentry}{NaKSa}{adj.}
        \dictdef{political of or relating to politics}
        \dictdef{controversial}
    \end{dictentry}
    \begin{dictentry}{NanaKS}{n.}
        \dictdef*{politician}
    \end{dictentry}
    \begin{dictentry}{iNuKSa}{n.}
        \dictdef*{parliamentary building}
    \end{dictentry}
    \begin{dictentry}{mNiKS}{n.}
        \dictdef*{talking point, argument}
    \end{dictentry}
    \begin{dictentry}{NuKSu}{n.}
        \dictdef*{\textit{derogatory} politician}
    \end{dictentry}
    \begin{dictentry}{aNiKSu}{n.}
        \dictdef*{debate session}
    \end{dictentry}
    \begin{dictentry}{uNiKSi}{adj.}
        \dictdef{unease or upset over someone else's decision}
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{q}{\bigglot}
    ...
    \begin{dictentry}{Qa\bigglot{}}{n.}
        \dictdef*{
            belief, claim, opinion, thought
        }
    \end{dictentry}
    \begin{dictentry}{Qii\bigglot}{v.tr}
        \dictdef*{
            to think, to believe, to claim, be of the opinion of
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{r}{t}
    ...
    \begin{dictentry}{RaT}{n.}
        ...
        \dictdef{
            weekend \textit{(short for \ref{word:HasiY-RaT})}
        }
    \end{dictentry}
    ...
    \begin{dictentry}{HasiY-RaT}{n.}\label{word:HasiY-RaT}
        \dictdef*{weekend, Saturday and Sunday}
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{sh}{n}
    ...
    \end{dictentry}
    \begin{dictentry}{SHaNia}{n.}\label{word:SHaNia}
        \dictdef{
            the kingdom of England, England as a nationstate
        }
        \dictdef{
            the Kingdom of Great Britain, the British Empire
        }
        \dictdef{
            \textit{(attested but considered incorrect)} the United Kingdom
        }
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{t}{w}
    \begin{dictentry}{TaW}{n.}
        \dictdef*{locomotion, rail transport}
    \end{dictentry}
    \begin{dictentry}{TaWa}{adj.}
        \dictdef{relating to trains, railway, or locomotion}
        \dictdef{relating to trams}
    \end{dictentry}
    \begin{dictentry}{TanaW}{n.}
        \dictdef*{train conductor}
    \end{dictentry}
    \begin{dictentry}{iTuWa}{n.}
        \dictdef*{station, stop}
    \end{dictentry}
    \begin{dictentry}{TuWu}{n.}
        \dictdef{train engine, tram engine}
        \dictdef{single-car train}
    \end{dictentry}
    \begin{dictentry}{TasiW}{n.}
        \dictdef{train or tram consisting of an engine and one or more cars}
    \end{dictentry}
    \begin{dictentry}{aTiWu}{n.}
        \dictdef{train track, tram track}
    \end{dictentry}
    \begin{dictentry}{TimiWu}{n.}
        \dictdef{trainyard}
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{w}{c}
    \begin{dictentry}{WaC}{n.}
        \dictdef*{
            danger, risk
        }
    \end{dictentry}
    \begin{dictentry}{WaCa}{adj.}
        \dictdef{
...
\begin{dictroot}{ws}{n}
    ...
    \begin{dictentry}{WeSiWSiyaN}{v.tr.}
        \dictdef*{
            to happen to \textit{smth.} or \textit{sme.}, to affect \textit{smth.} or \textit{sme.}
        }
    \end{dictentry}
...
\begin{description}[leftmargin=*,labelwidth=*]
    \begin{dictentry}{caa}{int.}
        \dictdef{
            \textit{expression of incredulity and/or disappointment}
            \textit{roughly equivalent to "really??"}
        }
    \end{dictentry}
    \begin{dictentry}{le}{int.}
        \dictdef{
            \textit{expression of confused surprise}
        }
    \end{dictentry}
    \begin{dictentry}{te}{int.}
        \dictdef{
            \textit{expression of neutral or positive surprise}
        }
    \end{dictentry}
